...
func TestPickExplorationItems_FiltersCorrectly(t *testing.T) {
	...
	result := PickExplorationItems(candidates, seenIDs, 1, 6*time.Hour, 0.4)
...
func TestPickExplorationItems_ReturnsEmpty(t *testing.T) {
	result := PickExplorationItems(nil, nil, 1, 6*time.Hour, 0.4)
...
func TestPickExplorationItems_SortsByQuality(t *testing.T) {
	...
	result := PickExplorationItems(candidates, nil, 2, 6*time.Hour, 0.4)
