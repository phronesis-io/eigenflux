...
func TestPostgresContextOwnershipAndCAS(t *testing.T) {
	...
	c := discovery.Context{ID: 10, OwnerID: 1, State: "active", Persistence: "saved", Origin: "saved_need", Revision: 1, Kinds: []discovery.Kind{discovery.Agent}, SpecHash: "a", CreatedAt: 100, UpdatedAt: 100}
