...
func TestAgentObservationSuccessAndReadBoundaries(t *testing.T) {
	tests := []struct {
		...
		{name: "Need creation", method: "POST", path: "/api/v2/needs", body: `{"code":0}`, status: 200, want: true},
		{name: "Need update", method: "PUT", path: "/api/v2/needs/:id", body: `{"code":0}`, status: 200, want: true},
		{name: "Need state", method: "POST", path: "/api/v2/needs/:id/state", body: `{"code":0}`, status: 200, want: true},
		{name: "Need read", method: "GET", path: "/api/v2/needs/:id", body: `{"code":0}`, status: 200},
