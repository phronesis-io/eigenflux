...
- `ENABLE_REPLAY_LOG`: Enable replay log publishing in FeedService. Default `true`. When `false`, FeedService skips publishing to `stream:replay:log` and ReplayConsumer is not started
