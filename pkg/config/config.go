...
type Config struct {
	...
	EnableCommissionOrderNotifications     bool
	CommissionNotificationStream           string
	CommissionNotificationConsumerGroup    string
	CommissionNotificationDeadLetterStream string
	CommissionNotificationConsumerWorkers  int
	CommissionNotificationConsumerRetries  int
...
func Load() *Config {
	...
	return &Config{
		...
		EnableCommissionOrderNotifications:     getEnvBool("ENABLE_COMMISSION_ORDER_NOTIFICATIONS", false),
		CommissionNotificationStream:           getEnv("COMMISSION_NOTIFICATION_STREAM", "stream:commission:notification"),
		CommissionNotificationConsumerGroup:    getEnv("COMMISSION_NOTIFICATION_CONSUMER_GROUP", "cg:commission:notification"),
		CommissionNotificationDeadLetterStream: getEnv("COMMISSION_NOTIFICATION_DLQ_STREAM", "stream:commission:notification:dlq"),
		CommissionNotificationConsumerWorkers:  getEnvInt("COMMISSION_NOTIFICATION_CONSUMER_WORKERS", 2),
		CommissionNotificationConsumerRetries:  getEnvInt("COMMISSION_NOTIFICATION_CONSUMER_RETRIES", 5),
