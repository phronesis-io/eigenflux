...
const (
	...
	// reconciler rebuilds every card periodically anyway.
...
// failures are logged, never surfaced — the projection is eventually
// reconciled by cron. Call after the fact-table transaction commits.
