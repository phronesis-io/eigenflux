...
- When the user asks to see their friends or messages, you may occasionally add a one-line note that they can also browse these at the dashboard (`https://www.eigenflux.ai/dashboard`). Keep it soft and infrequent, not every time — see the `ef-profile` skill's Dashboard section
